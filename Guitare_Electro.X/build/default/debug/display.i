...
# 3 "display.c" 2
 ...
 void display_init(){
    ...
    display_print(0x0, 0x0, 0x0, 0x0, 0);
}

 void display_start() {
    LATCbits.LATC4 = 1;
    _delay((unsigned long)((2)*(8000000UL/4000000.0)));
    LATCbits.LATC3 = 1;
    _delay((unsigned long)((2)*(8000000UL/4000000.0)));
    LATCbits.LATC4 = 0;
    _delay((unsigned long)((2)*(8000000UL/4000000.0)));
...
void display_print_int(uint16_t intValue){
    ...
    display_print(toPrint[0],toPrint[1],toPrint[2],toPrint[3],0);
