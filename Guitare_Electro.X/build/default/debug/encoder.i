...
void fx_encoder_rotating(int * COUNT2,int * current_fx){
  ...
  {
      COUNT2 ++;
      if(COUNT2 > 3) fx_increase(COUNT2, current_fx);
  }
  else
  {
      COUNT2 --;
      if(COUNT2 < (-3)) fx_decrease(COUNT2, current_fx);
  }
...
void send_fx_choice(int current_fx){
    ...
    LATBbits.LATB0 = (current_fx % 2);
    LATDbits.LATD7 = ((current_fx>>1)%2);
    LATDbits.LATD6 = ((current_fx>>2)%2);
    LATDbits.LATD5 = ((current_fx>>3)%2);
...
void vol_encoder_rotating(int * COUNT,int * current_volume){
  ...
  {
      *COUNT ++;
      if(*COUNT > 3) vol_increase(COUNT, current_volume);
  }
  else
  {
      *COUNT--;
      if(*COUNT < (-3)) vol_decrease(COUNT, current_volume);
  }
  return;
}
...
void vol_increase(int * COUNT,int * current_volume){
    ...
    *COUNT = 0;
    if(*current_volume<20)*current_volume++;
...
unsigned char* get_current_value_into_string(int value){
    ...
    for (unsigned int i = 0; i<2; i++){
        ...
        switch(number){
            ...
            case '0':
                toPrint[i]=0b00111111;
                break;
            case '1':
                toPrint[i]=0b00000110;
                break;
            case '2':
                toPrint[i]=0b01011011;
                break;
            case '3':
                toPrint[i]=0b01001111;
                break;
            case '4':
                toPrint[i]=0b01100110;
                break;
            case '5':
                toPrint[i]=0b01101101;
                break;
            case '6':
                toPrint[i]=0b01111101;
                break;
            case '7':
                toPrint[i]=0b00000111;
                break;
            case '8':
                toPrint[i]=0b01111111;
                break;
            case '9':
                toPrint[i]=0b01101111;
                break;
            default:
                toPrint[i]=0x0;
